  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            ronk = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        ronk-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        ronk-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        ronk-audit = craneLib.cargoAudit {
      ...
      apps = forAllSystems ({system, ...}: {
        ronk = {
          type = "app";
          program = "${self.packages.${system}.ronk}/bin/ronk";
        };
        default = self.apps.${system}.ronk;
      });
